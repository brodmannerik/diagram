...
function App() {
  ...
  // New state for hover information
  ...
  useEffect(() => {
    ...
    const handleMouseOver = (e: MouseEvent) => {
      ...
      if (target.tagName === "rect" || target.classList.contains("variable")) {
  ...
  }, [isColored]); // Re-run when color toggle changes
  ...
  return (
    <>
        ...
        <Button size="4" onClick={handlePaperClick} style={whiteButtonStyle}>
          <Flex align="center" gap="2">
            ...
            <svg
              ...
              style={{ color: "#0000FF" }} // Match the button text color
            >
              <path
      ...
      {/* Bottom right info button - only visible when hovering over elements */}
      {hoverElement !== "none" && (
        <div
          style={{
            position: "fixed",
        ...
        >
          <Button size="4" style={whiteButtonStyle}>
            <Flex align="center" gap="2">
              ...
              <span>{getElementDescription(hoverElement)}</span>
            </Flex>
          </Button>
        </div>
      )}
